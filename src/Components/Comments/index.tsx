...
export function Comment({author, title, rating, comment, createdAt, variant}:Comments){
        ...
        <div className="container-comment-main">
            ...
            <div className="container-title">
                ...
                {variant !== "muthed-avatar" ?
                    <div className="avatar">
                        <Text variant="font-semibold subheadline headline">{getInitials(author)}</Text>
                    </div> :
                    <div className="muthed-avatar">
                        {getInitials(author)}
                    </div> 
                }
            ...
            <div className="container-comment-options">
                <div className="container-comment-option-report">
                    <Text variant="font-regular caption muted">Este problema teve solução?</Text>
